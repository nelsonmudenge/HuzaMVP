...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],6704)},18622,(a,b,c)=>{b.exports=a.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(a,b,c)=>{b.exports=a.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(a,b,c)=>{b.exports=a.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},20635,(a,b,c)=>{b.exports=a.x("next/dist/server/app-render/action-async-storage.external.js",()=>require("next/dist/server/app-render/action-async-storage.external.js"))},24361,(a,b,c)=>{b.exports=a.x("util",()=>require("util"))},14747,(a,b,c)=>{b.exports=a.x("path",()=>require("path"))},52092,a=>{"use strict";var b=a.i(87924),c=a.i(72131);a.i(30485);var d=a.i(70896);a.i(69387);var e=a.i(60574),f=a.i(36383);let g=(0,c.createContext)(null);function h({children:a}){let[h,i]=(0,c.useState)(null),[j,k]=(0,c.useState)(null),[l,m]=(0,c.useState)(!0);(0,c.useEffect)(()=>(0,d.onAuthStateChanged)(f.auth,async a=>{if(a){i(a);let b=await (0,e.getDoc)((0,e.doc)(f.db,"users",a.uid));b.exists()&&k(b.data())}else i(null),k(null);m(!1)}),[]);let n={user:h,userProfile:j,loading:l,register:async function({email:a,password:b,name:c,role:g,commissionRate:h=0,commissionAgreed:i=!0}){let{user:j}=await (0,d.createUserWithEmailAndPassword)(f.auth,a,b);return await (0,d.updateProfile)(j,{displayName:c}),await (0,e.setDoc)((0,e.doc)(f.db,"users",j.uid),{uid:j.uid,name:c,email:a,role:g,commissionRate:h,commissionAgreed:i,createdAt:(0,e.serverTimestamp)(),verified:!1}),j},login:async function(a,b){return(0,d.signInWithEmailAndPassword)(f.auth,a,b)},loginWithGoogle:async function(a="student"){let b=new d.GoogleAuthProvider,{user:c}=await (0,d.signInWithPopup)(f.auth,b),g=(0,e.doc)(f.db,"users",c.uid);return(await (0,e.getDoc)(g)).exists()||await (0,e.setDoc)(g,{uid:c.uid,name:c.displayName,email:c.email,role:a,createdAt:(0,e.serverTimestamp)(),verified:!1}),c},logout:async function(){await (0,d.signOut)(f.auth)},isStudent:j?.role==="student",isLandlord:j?.role==="landlord",isAdmin:j?.role==="admin"};return(0,b.jsx)(g.Provider,{value:n,children:!l&&a})}function i(){let a=(0,c.useContext)(g);if(!a)throw Error("useAuth must be used within AuthProvider");return a}a.s(["AuthProvider",()=>h,"useAuth",()=>i])},62036,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(86723),e=a.i(74290),f=a.i(14800),g=c,h=a.i(65802);class i extends g.Component{getSnapshotBeforeUpdate(a){let b=this.props.childRef.current;if(b&&a.isPresent&&!this.props.isPresent){let a=this.props.sizeRef.current;a.height=b.offsetHeight||0,a.width=b.offsetWidth||0,a.top=b.offsetTop,a.left=b.offsetLeft}return null}componentDidUpdate(){}render(){return this.props.children}}function j({children:a,isPresent:c}){let d=(0,g.useId)(),e=(0,g.useRef)(null),f=(0,g.useRef)({width:0,height:0,top:0,left:0}),{nonce:j}=(0,g.useContext)(h.MotionConfigContext);return(0,g.useInsertionEffect)(()=>{let{width:a,height:b,top:g,left:h}=f.current;if(c||!e.current||!a||!b)return;e.current.dataset.motionPopId=d;let i=document.createElement("style");return j&&(i.nonce=j),document.head.appendChild(i),i.sheet&&i.sheet.insertRule(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e5e0dbb._.js.map