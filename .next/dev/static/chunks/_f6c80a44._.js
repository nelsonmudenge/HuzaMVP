...
function LoginPage() {
    ...
    const { login, loginWithGoogle } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$context$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    async function handleLogin(e) {
        ...
        try {
            ...
            const msg = err.code === 'auth/user-not-found' ? 'No account found with this email' : err.code === 'auth/wrong-password' ? 'Incorrect password' : 'Login failed. Please try again.';
    ...
    async function handleGoogleLogin() {
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Signed in with Google!');
            router.push('/');
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Google sign-in failed');
        } finally{
            setLoading(false);
        }
    }
...
_s(LoginPage, "VgfdVJMFerFh9M6v2d0fFdIM62A=", false, function() {
    return [
...
//# sourceMappingURL=_f6c80a44._.js.map